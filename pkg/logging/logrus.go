...
func (l *Logrus) Log(level Level, args ...interface{}) {
	l.logger.Log(logrus.Level(level), args...)
}

func (l *Logrus) Logln(level Level, args ...interface{}) {
	l.logger.Logln(logrus.Level(level), args...)
}

func (l *Logrus) Logf(level Level, format string, args ...interface{}) {
	l.logger.Logf(logrus.Level(level), format, args...)
}

func (l *Logrus) LogFields(level Level, fields Fields, args ...interface{}) {
	l.logger.WithFields(logrus.Fields(fields)).Log(logrus.Level(level), args...)
}

func (l *Logrus) LogFieldsln(level Level, fields Fields, args ...interface{}) {
	l.logger.WithFields(logrus.Fields(fields)).Logln(logrus.Level(level), args...)
}

func (l *Logrus) LogFieldsf(level Level, fields Fields, format string, args ...interface{}) {
